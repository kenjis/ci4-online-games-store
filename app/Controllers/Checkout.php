...
class Checkout extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('name', 'Name', 'required', ['required' => 'Name is requried.']);
        $this->form_validation->set_rules('address', 'Address', 'required', ['required' => 'Address is requried.']);
