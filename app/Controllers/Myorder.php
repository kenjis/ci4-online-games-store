...
class Myorder extends CI_Controller
{
    ...
    public function detail($invoice): void
    {
        $data['title']              = 'My Order';
    ...
    public function confirm($invoice): void
    {
        $this->form_validation->set_rules('account_name', 'Acoount name', 'required', ['required' => 'Acoount name is required.']);
